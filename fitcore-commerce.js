// FITCORE commerce configuration helpers.
// Browserda window.FitcoreCommerce, Node regression testlarida module.exports sifatida ishlaydi.
(function attachFitcoreCommerce(root, factory) {
  const api = factory();
  if (typeof module === 'object' && module.exports) module.exports = api;
  root.FitcoreCommerce = api;
})(typeof globalThis !== 'undefined' ? globalThis : window, function buildFitcoreCommerce() {
  'use strict';
